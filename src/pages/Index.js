  ...
  return (
    <>
      ...
      <>
              ...
              <div className='flex justify-between items-center w-full'>
                ...
                <div className='w-1/2 xl:w-1/3'>
                  <ul className='hidden xl:flex xl:justify-center'>
                    <li className='mr-12'>
                      <a className='text-coolGray-500 hover:text-coolGray-900 font-medium' href='#'>
                        Insurance Plans
                      </a>
                    </li>
                    <li className='mr-12'>
        ...
        <section
          className='py-24 md:py-32 bg-white overflow-hidden' style={{ backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center' }}>
          <div className='container px-4 mx-auto'>
        ...
        <section className='pt-24 bg-white' style={{ backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center' }}>
          <div className='container px-4 mx-auto'>
