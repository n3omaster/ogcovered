...
export default function Index() {
  ...
  const videoUrl = "/vids/ogcovered.mp4";
      ...
      <>
        <section className='relative bg-white overflow-hidden' style={{ backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center' }}>
          <div className='bg-transparent'>
            <nav className='flex justify-between p-1 px-4'>
              <div className='flex justify-between items-center w-full'>
                ...
                <div className='w-1/2 xl:w-1/3'>
                  <ul className='hidden xl:flex xl:justify-center'>
                    ...
                    <li>
                      <a className='text-coolGray-500 hover:text-coolGray-900 font-medium' href='#perks'>
                        Perks
                      </a>
                    </li>
                  </ul>
              ...
              <button className='navbar-burger self-center xl:hidden' onClick={handleBurger}>
            ...
            <div className={`navbar-menu ${show ? '' : 'hidden'} fixed top-0 left-0 z-50 w-full h-full bg-coolGray-900 bg-opacity-50`}>
              <div className='fixed top-0 left-0 bottom-0 w-full max-w-xs bg-white'>
                <nav className='relative p-1 h-full overflow-y-auto'>
                  <div className='flex flex-col justify-between h-full'>
                    ...
                    <ul className='py-6'>
                      ...
                      <li>
                        <a className='block py-3 px-4 text-coolGray-500 hover:text-coolGray-900 font-medium hover:bg-coolGray-50 rounded-md' href='#perks'>
                          Perks
                        </a>
                      </li>
                    </ul>
                ...
                <button className='navbar-close absolute top-5 p-1 right-3' onClick={handleBurger}>
          ...
          <div className='py-20 md:py-28'>
            <div className='container px-4 mx-auto'>
              <div className='flex flex-wrap xl:items-center -mx-4'>
                <div className='w-full md:w-5/12 px-2 mb-16 md:mb-0 animate__animated animate__fadeInLeft  text-right'>
                  ...
                  <h1 className='mb-6 text-5xl md:text-5xl lg:text-5xl leading-tight font-bold tracking-tight text-right'>
                    With OGCovered<br /> it feels good to be covered
                  </h1>
                ...
                <div className='w-full md:w-7/12 px-4 animate__animated animate__fadeInRight'>
                  <div className='relative mx-auto md:mr-0 max-w-max'>
                    <img className='absolute z-10 -left-8 -top-12 w-28 md:w-auto' src='flex-ui-assets/elements/circle3-yellow.svg' alt='ogcovered' />
                    ...
                    <div className='relative overflow-hidden rounded-7xl'>
                      <video controls width="100%" className='' poster='/imgs/ogcovered-health-broker.jpg' loop muted autoPlay playsInline>
            ...
            <div className='flex flex-wrap -mx-4'>
              <div className='w-full lg:w-1/3 px-4 lg:pt-6 mb-8 lg:mb-0'>
                <div className='p-8 lg:mb-6 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200'>
                  <div className='inline-flex h-16 w-16 mb-6 mx-auto items-center justify-center text-white bg-green-500 rounded-lg p-3'>
                    <img src='/svg/like-right-svgrepo-com.svg'></img>
                  </div>
                ...
                <div className='p-8 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200'>
                  <div className='inline-flex h-16 w-16 mb-6 mx-auto items-center justify-center text-white bg-green-500 rounded-lg p-4'>
                    <img src='/svg/health-insurance-finance-svgrepo-com.svg'></img>
                  </div>
                  <h3 className='mb-4 text-xl md:text-2xl leading-tight font-bold'>
                    Making healthcare more available
                  </h3>
                </div>
              </div>
              ...
              <div className='w-full lg:w-1/3 lg:pt-6 px-4'>
                <div className='p-8 lg:mb-6 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200'>
                  <div className='inline-flex h-16 w-16 mb-6 mx-auto items-center justify-center text-white bg-green-500 rounded-lg p-4'>
                    <img src='/svg/health-svgrepo-com.svg'></img>
                  </div>
                  <h3 className='mb-4 text-xl md:text-2xl leading-tight font-bold'>
                    Making health coverage fair and accessible.
                  </h3>
                </div>
                <div className='p-8 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200'>
                  <div className='inline-flex h-16 w-16 mb-6 mx-auto items-center justify-center text-white bg-green-500 rounded-lg p-4'>
                    <img src='/svg/trend-down-svgrepo-com.svg'></img>
                  </div>
                  <h3 className='mb-4 text-xl md:text-2xl leading-tight font-bold'>
        ...
        <section id="benefits" className='py-24 bg-white  animate__animated animate__fadeInUp' style={{ backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center', }}>
          <div className='container px-4 mx-auto'>
            <div className='max-w-5xl mx-auto text-center mb-16 md:mb-24'>
              ...
              <p className='text-lg md:text-xl text-coolGray-500 font-medium'>
                Depending on your income, you might qualify for a subsidy in the form of a premium tax credit, reducing monthly premiums and out-of-pocket expenses and saving you hundreds of dollars on medical bills.
              </p>
              <p className='text-lg md:text-xl text-coolGray-500 font-medium mt-4'>
        ...
        <section id="qualify" className='bg-white animate__animated animate__fadeInUp' style={{ backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center' }}>
          <div className='container px-4 mx-auto'>
            <div className='relative -mb-40 py-16 px-4 md:px-8 lg:px-16 bg-coolGray-800 rounded-md overflow-hidden'>
              ...
              <div className='relative max-w-max mx-auto text-center'>
                ...
                <p className='mb-6 text-base md:text-xl text-coolGray-400'>
                  Everyone is eligible for a free consultation. Call us now and get covered today!
                </p>
            ...
            <div className='flex flex-wrap items-center justify-center lg:justify-between -mx-4'>
              ...
              <div className='w-full lg:w-2/6 px-4 mb-12 lg:mb-0'>
                <div className='relative pt-12 pb-6 sm:p-6'>
                  <img className='absolute top-0 left-0' src='flex-ui-assets/elements/testimonials/quote-top-green.svg' alt='ogcovered' />
                  <img className='absolute bottom-0 right-0' src='flex-ui-assets/elements/testimonials/quote-down-green.svg' alt='ogcovered' />
                ...
                <div className='flex flex-wrap -mx-4'>
                  <div className='w-full md:w-1/2 px-4 mb-10'>
                    <div className='max-w-xs mx-auto'>
                      ...
                      <a className='text-lg md:text-xl text-coolGray-500 hover:text-coolGray-600 font-medium' href='mailto:info@ogcovered.com'>
                        info@ogcovered.com
                      </a>
                    </div>
                  </div>
                  <div className='w-full md:w-1/2 px-4 mb-10'>
                    <div className='max-w-xs mx-auto'>
                      ...
                      <a className='text-lg md:text-xl text-coolGray-500 font-medium' href='tel:+1 773 800 4261'>
                        +1 773 800 4261
                      </a>
                    </div>
                  </div>
                ...
                <div className='px-4 py-8 md:p-10 bg-coolGray-50 rounded-md'>
                  <form>
                    <div className='mb-6'>
                      ...
                      <input className='block w-full py-2 px-3 appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50' type='email' placeholder='myemail@gmail.com' />
                    </div>
                    <div className='mb-6'>
                      <label className='block mb-2 text-coolGray-800 font-medium leading-6' htmlFor=''>
                        Message
                      </label>
                      <textarea className='block h-32 md:h-52 w-full py-2 px-3 appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 placeholder-coolGray-200 resize-none' type='text' placeholder='Leave us your message here, we`ll contact you...' defaultValue={''} />
                    </div>
        ...
        <section id='footer' className='bg-white overflow-hidden animate__animated animate__fadeIn' style={{ backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center' }}>
          <div className='container px-4 mx-auto'>
            <div id="perks" className='flex flex-wrap lg:items-center pt-24 pb-12 -mx-4'>
