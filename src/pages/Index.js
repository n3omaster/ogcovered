                ...
                <div className='w-full md:w-1/2 px-4'>
                  <div className='relative mx-auto md:mr-0 max-w-max'>
                    ...
                    <div className='relative overflow-hidden rounded-7xl'>
                      <img src='/imgs/ogcovered-health-broker.jpg' />
                      <video className='absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 min-h-full min-w-full max-w-none' poster='/imgs/ogcovered-health-broker.jpg' muted='' >
                        <source src='/vids/ogcovered.mp4' type='video/mp4' />
                      </video>
                    </div>
                  </div>
                </div>
